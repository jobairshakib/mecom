...
<div class="col-12 col-lg12 col-xxl-9 d-flex">
    <div class="card flex-fill">
        <div class="card-header">
            ...
            <div class="row mb-3"><h2 class="col-sm-3">Title:</h2> <h2 class="col-sm-9">{{$brand->brand_name}}</h2></div>
            <div class="row"><h2 class="col-sm-3">Image:</h2><div class="col-sm-9"> <img src="{{asset($brand->brand_image)}}" alt="brand_image" width="200px" height="250px"></div></h2></div>
        </div>
    </div>
</div>
</x-admin.layouts.admin_master>
